# D-Lab's Excel Fundamentals Workshop
This repository contains the materials for D-Lab's Excel Fundamentals workshop. No prior experience is assumed.
...
2. Download the workbook "Excel Training Workbook.xlsx" from the Google Drive folder ([link here])
3. Open the downloaded workbook on your computer using Microsoft Excel

Google Sheets users - complete the following steps: 
1. Open the Google Drive folder ([link here])
